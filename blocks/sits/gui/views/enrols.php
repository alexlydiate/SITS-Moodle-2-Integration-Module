...
//  Lists all the users within a given course
    ...
    $PAGE->set_url('/blocks/sits/gui/views/enrols.php', array(
            'page' => $page,
            'perpage' => $perpage,
            'mode' => $mode,
...
/*
    ...
    $PAGE->set_pagelayout('sits_enrol');
    require_capability('moodle/site:viewparticipants', $systemcontext);

    $rolenamesurl = new moodle_url("$CFG->wwwroot/blocks/sits/gui/views/enrols.php?contextid=$context->id&sifirst=&silast=");
...
/// and if so, set $currentgroup to reflect the current group
    ...
    $baseurl = new moodle_url('/blocks/sits/gui/views/enrols.php', array(
...
/// Print my course menus
    if ($mycourses = enrol_get_my_courses()) {
        $courselist = array();
        $popupurl = new moodle_url('/blocks/sits/gui/views/enrols.php?roleid='.$roleid.'&sifirst=&silast=');
